...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(// Here we take the value from the MyHomePage object that was created by
      ...
      body: Center(// Center is a layout widget. It takes a single child and positions it
        ...
        child: Column(// Column is also a layout widget. It takes a list of children and
          ...
          children: <Widget>[Text('You have pushed the button this many times:',), Text('$_counter', style: Theme
              .of(context)
              .textTheme
              .display1,),
          ],),),
